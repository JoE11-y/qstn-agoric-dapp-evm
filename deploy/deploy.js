...
const acceptProposal = async () => {
  ...
  const baseDir = '.';
  const submitCommand = `cd ${baseDir} && agd tx gov submit-proposal swingset-core-eval ${permit} ${script} --title='Install ${script}' --description='Deploy QSTN ${script}' --deposit=10000ubld --from ${walletName} ${SIGN_BROADCAST_OPTS} -o json`;
